...
void OttApplication::cleanupSwapChain()
{
...
//-----------------------------------------------------------------------------
void OttApplication::cleanupUBO()
{
...
//-----------------------------------------------------------------------------
void OttApplication::cleanupModelObjects()
{
...
//----------------------------------------------------------------------------
void OttApplication::createInstance()
{
...
//----------------------------------------------------------------------------
void OttApplication::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo = {
...
//----------------------------------------------------------------------------
void OttApplication::setupDebugMessenger()
{
...
//----------------------------------------------------------------------------
void OttApplication::pickPhysicalDevice()
{
...
void OttApplication::createLogicalDevice()
{
...
//----------------------------------------------------------------------------
void OttApplication::createSwapChain()
{
...
//-----------------------------------------------------------------------------
void OttApplication::recreateSwapChain()
{
...
//----------------------------------------------------------------------------
void OttApplication::createImageViews()
{
...
//----------------------------------------------------------------------------
void OttApplication::createRenderPass()
{
...
//----------------------------------------------------------------------------
void OttApplication::createFramebuffers()
{
...
//----------------------------------------------------------------------------
void OttApplication::createCommandPool()
{
...
//----------------------------------------------------------------------------
void OttApplication::createColorResources()
{
...
//----------------------------------------------------------------------------
void OttApplication::createDepthResources()
{
...
//----------------------------------------------------------------------------
void OttApplication::createCommandBuffers()
{
...
//----------------------------------------------------------------------------
void OttApplication::createSyncObjects()
{
